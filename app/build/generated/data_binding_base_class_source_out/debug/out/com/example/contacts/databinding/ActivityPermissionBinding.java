...
public final class ActivityPermissionBinding implements ViewBinding {
  ...
  private ActivityPermissionBinding(@NonNull RelativeLayout rootView,
      @NonNull AppCompatButton btnPermission) {
  ...
  public static ActivityPermissionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      AppCompatButton btnPermission = ViewBindings.findChildViewById(rootView, id);
      if (btnPermission == null) {
        break missingId;
      }

      return new ActivityPermissionBinding((RelativeLayout) rootView, btnPermission);
    }
